...
Object.assign(_baseattr.default.attrDefaultValues, {
  state: 'default',
  states: {},
  actions: {
    'beforeEnter:': {
...
var target = _baseattr.default.prototype;
Object.defineProperties(target, {
  states: (0, _utils.attr)(target, 'states', {
    set: function set(val) {
      val = Object.assign({}, val);
      var states = this.get('states'); // recover __default
  ...
  actions: (0, _utils.attr)(target, 'actions', {
    set: function set(val) {
  ...
  state: (0, _utils.attr)(target, 'state', {
    set: function set(val) {
  ...
  enterMode: (0, _utils.attr)(target, 'enterMode', {
    set: function set(val) {
      this.set('enterMode', val);
    }
  }),
  exitMode: (0, _utils.attr)(target, 'exitMode', {
    set: function set(val) {
