...
var PathSpriteAttr = _decorate(null, function (_initialize, _BaseSprite$Attr) {
  ...
  return {
    ...
    d: [{
      ...
      kind: "set",
      decorators: [_utils.attr, (0, _utils.inherit)(1)],
      key: "lineWidth",
      value: function value(val) {
      ...
      kind: "set",
      decorators: [(0, _utils.parseValue)(_utils.parseStringFloat), _utils.attr],
      key: "lineDash",
      value: function value(val) {
      ...
      kind: "set",
      decorators: [_utils.attr, (0, _utils.inherit)('box')],
      key: "bounding",
      value: function value(val) {
        // box | path
...
var Path = _decorate(null, function (_initialize2, _BaseSprite) {
  ...
  function (_BaseSprite2) {
    ...
    function Path(attr) {
      ...
      _this2 = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(Path).call(this, attr));
