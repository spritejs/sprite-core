  ...
  (0, _createClass3.default)(Group, [{
    ...
    value: function relayout() {
      ...
      var items = this.children.filter(function (child) {
        return child.attr('position') !== 'absolute';
      });
      ...
      for (var _i = 0; _i < items.length; _i++) {
        ...
        if (mainSize === 'height') {
          ...
          if (itemMainSize > groupMainSize) {
            _item.attr(mainSize, groupMainSize);
          }
      ...
      if (mainSpace < 0) {
        ...
        for (var _i2 = 0; _i2 < items.length; _i2++) {
          ...
          if (_itemStyle.flex) {
            _item2.attr(mainSize, 0);
          }

          _item2.attr(mainSize, _item2.attr(mainSize) * scale);

          _item2.attr(mainStart, currentMain);
          _item2.attr(mainEnd, _item2.attr(mainStart) + mainSign * _item2.attr(mainSize));
        ...
        flexLines.forEach(function (items) {
          ...
          if (flexTotal > 0) {
            ...
            for (var _i4 = 0; _i4 < items.length; _i4++) {
              ...
              if (_itemStyle3.flex) {
                _item4.attr(mainSize, mainSpace / flexTotal * _itemStyle3.flex);
              }

              _item4.attr(mainStart, _currentMain);
              _item4.attr(mainEnd, _item4.attr(mainStart) + mainSign * _item4.attr(mainSize));
            ...
            for (var _i5 = 0; _i5 < items.length; _i5++) {
              ...
              _item5.attr(mainSize, _item5.attr(mainSize) || 0);
              _item5.attr(mainStart, _currentMain2);
              _item5.attr(mainEnd, _item5.attr(mainStart) + mainSign * _item5.attr(mainSize));
      ...
      if (isAutoSize(style[crossSize])) {
        ...
        for (var _i6 = 0; _i6 < flexLines.length; _i6++) {
          crossSpace -= flexLines[_i6].crossSpace;
        }
      }
      ...
      flexLines.forEach(function (items) {
        ...
        for (var _i7 = 0; _i7 < items.length; _i7++) {
          var _item6 = items[_i7];

          var align = _item6.attributes.alignSelf || style.alignItems;

          if (isAutoSize(_item6.attr(crossSize))) {
            _item6.attr(crossSize, align === 'stretch' ? lineCrossSize : 0);
          } else {
            _item6.attr(crossSize, _item6.attr(crossSize));
          }
          ...
          if (align === 'stretch') {
            ...
            _item6.attr(crossSize, crossSign * (_item6.attr(crossEnd) - _item6.attr(crossStart)));
          }
        }
